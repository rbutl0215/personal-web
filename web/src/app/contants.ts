import { DialogueProps } from "@/components/Dialogue";
...
export const projects: ProjectCardProps[] = [
  {
    title: "Describby",
    description:
      "AI based tooled to assist in content creation for real estate agents",
    imageUrl:
      "https://nlp7257gkjhtxzam.public.blob.vercel-storage.com/describby-4ZSDsxMbfbrXiNzL8zDVQeATLkWGTe.png",
  ...
  },
  {
    ...
    imageUrl:
      "https://nlp7257gkjhtxzam.public.blob.vercel-storage.com/probability-trees-QC1qugZzlZW1DEgm6AcoW8vbgEtrhp.png",
    link: "https://github.com/rbutl0215/probability-trees",
  },
  {
    title: "Brewery on Mars",
    description:
      "An internal training tool that went from Excel to full blown web app",
    imageUrl:
      "https://nlp7257gkjhtxzam.public.blob.vercel-storage.com/brewery-on-mars-AlLXXWESQD2LITqkGcFwscd6tN9U7T.png",
    link: "https://see6.ai/case-studies/ai-simulation-for-anheuser-busch",
  },
];

export const dialogue: DialogueProps = {
  messages: [
    {
      id: 0,
      speaker: "A",
      text: "Hey, I'm starting a software development team. Want to join?",
    },
    {
      id: 1,
      speaker: "B",
      text: "I'm not a software engineer.",
    },
    {
      id: 2,
      speaker: "A",
